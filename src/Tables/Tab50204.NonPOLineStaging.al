table 50204 "Non PO Line Staging"
{
    Caption = 'Non PO Line Staging';
   ...
   fields
    {
        ...
        field(3; "Invoice No."; Text[50])
        {
            Caption = 'Invoice No.';
        }
        field(4; "Item No."; Text[50])
        {
            Caption = 'Item No.';
        }
        ...
        field(44; "Z_FamilyCode"; Text[200])
        {
            Caption = 'Family Code';
        }
        field(45; "Z_VehRegNumberCode"; Text[200])
        {
            Caption = 'Veh Reg Number Code';
        }
