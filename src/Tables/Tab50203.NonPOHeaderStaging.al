table 50203 "Non PO Header Staging"
{
    Caption = 'Non PO Header Staging';
    ...
    fields
    {
        ...
        field(40; "Invoice Number"; Integer)
        {
        ...
        field(61; "Process Error"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(62; "Line Type"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
        field(63; "Tax Code"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
        field(64; "Tax Rate"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(65; "Import Error"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
        field(66; "LineData Error"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(100; "Posted Purch. Invoice No."; Code[50])
        {
            DataClassification = ToBeClassified;
        }
         field(67; "File Name"; Text[150])
        {
            DataClassification = ToBeClassified;
        }
          field(68; "Document Type"; Text[150])
        {
            DataClassification = ToBeClassified;
        }
        field(69; "Esker Exch. Rate Amount"; Decimal)
        {
