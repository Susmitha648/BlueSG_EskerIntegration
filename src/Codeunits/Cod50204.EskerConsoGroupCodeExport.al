codeunit 50204 "Esker Conso Group Code Export"
{
    trigger OnRun()
    var
    ...
    begin
        ...
        Xmlport.Export(Xmlport::"Conso Group Code Export", OutStream);
        TempBlob.CreateInStream(InStream);
        CompanyInfo.Get();
        FileName := CompanyInfo."Company Code" + 'ESKER__ConsoGroupCode__' + FORMAT(CurrentDateTime, 0, '<Year4><Month,2><Day,2><Hours24,2><Minutes,2><Seconds,2>') + '.csv';
