codeunit 50202 "Esker Billing Period Export"
{
    trigger OnRun()
    var
    ...
    begin
        ...
        Xmlport.Export(Xmlport::"Billing Period Export", OutStream);
        TempBlob.CreateInStream(InStream);
        CompanyInfo.Get();
        FileName := CompanyInfo."Company Code" + 'ESKER__BillingPeriod__' + FORMAT(CurrentDateTime, 0, '<Year4><Month,2><Day,2><Hours24,2><Minutes,2><Seconds,2>') + '.csv';
